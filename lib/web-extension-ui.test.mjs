...
const { createWebExtensionUIAdapter, createFallbackThemeStub, appendCapabilityNotice, MAX_CAPABILITY_NOTICES } = await jiti.import("./web-extension-ui.ts");
...
test("能力提示快照有上限：超出保留最新，状态不会被撑到无界（issue #93 P2）", () => {
  // 取舍写在 MAX_CAPABILITY_NOTICES 的注释里：宿主能力提示的种类是枚举（当前 8 种），
